...
3. 确认桌面文件能力是否仍存在阻塞
4. 标记当前 V1.1 未实现 API
5. 确认当前已实现链路如何支持“素材 -> 原创 -> 关联 -> 主题 -> 写作”
...
## 3.1 Milestone 0.5：原创笔记优先界面改版

### 目标

在不改底层数据模型的前提下，把产品默认体验从“三类笔记并列”调整为“原创笔记主路，随笔和文献作为素材入口”。

### 范围

1. 全局主按钮默认指向 `新建原创笔记`
2. 左侧导航将随笔和文献收纳为 `素材入口`
3. 文献笔记默认界面简化为摘录、转述、支持判断、记录原创
4. 完整来源字段放入折叠区
5. 首页和工作台指标优先展示原创笔记、关系、主题和写作准备
...
1. 用户首次进入时看到的主行动是新建原创笔记
2. 随笔和文献不再像与原创并列的主知识库
3. 用户从随笔或文献能一键进入记录原创流程
4. 文献复杂来源字段默认折叠
5. 写作中心仍只接受原创笔记
...
1. 原创笔记可保存 `thesis`
2. 原创笔记可保存恰好 3 项的 `three_line_summary`
3. 非 3 项的三句话压缩被拒绝
...
1. 未填写 `thesis` 的原创笔记进入待一句话队列
2. 未填写 `three_line_summary` 的原创笔记进入待三句话队列
3. 首页主指标展示原创判断相关数据
4. 导入量不再是主视觉 KPI
5. 点击队列项能定位到对应笔记
