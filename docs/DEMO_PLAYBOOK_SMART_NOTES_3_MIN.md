...
- Open `/demo/zettelkasten` for the story page.
- Open `/prototype?demo=smart-notes-product-thinking` for the interactive workspace.
- Keep the graph, index cards, and writing project panels ready.
...
Call out the source boundary first: the demo uses original paraphrases and product-manager restatements, not copied book text.
