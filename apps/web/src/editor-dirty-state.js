...
const editorPaneStateMethods = {
  ...
  renderInspectorVisibility() {
    ...
    if (this.els.showRelated) {
      ...
      this.els.showRelated.dataset.tip = visible ? "收起打磨工作台" : "打开打磨笔记";
      this.els.showRelated.title = visible ? "收起打磨工作台" : "打开打磨笔记";
    }
    if (this.els.hideRelated) {
      ...
      this.els.hideRelated.title = visible ? "收起打磨工作台" : "打开打磨笔记";
    }
  },
