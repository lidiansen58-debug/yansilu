...
export class EditorPane {
  ...
  handleEditorInput() {
      ...
      const explicitEmptyLinkTrigger = inline && !inline.query && this.getEditorValue().slice(inline.start, inline.end) === "[[";
      const explicitEmptyTagTrigger = tagInline && !tagInline.query;
