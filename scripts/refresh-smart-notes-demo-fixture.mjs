...
async function main() {
  ...
  fixture.guide_notes = asArray(fixture.guide_notes).map((guide) => ({
    ...guide,
    title: "00-Read This First - 从来源到判断，再到写作",
    body: [
      "# 00-Read This First - 从来源到判断，再到写作",
      "",
      "This demo is a worked product example, not a replacement for *How to Take Smart Notes*.",
      "",
      "如果你只有五分钟，可以直接按这条路径人工验收：",
      "",
      "If you only have five minutes, follow this path:",
      "",
      "1. Start with the source card `SRC-SMART-NOTES`，先看阅读边界、提取范围和转换政策。",
      "2. 看两条随笔 `FN-SN-001`、`FN-SN-002`，确认“快速捕捉”仍然被明确标记为待处理而不是已完成。",
      "3. 随机打开几条文献笔记，检查来源边界、原创转述、知识点提取、候选永久笔记和待追问问题是否都成链出现。",
      "4. 优先读九条关键笔记 `PN-SN-001`、`PN-SN-013`、`PN-SN-021`、`PN-SN-033`、`PN-SN-049`、`PN-SN-065`、`PN-SN-077`、`PN-SN-085`、`PN-SN-093`，它们分别锚定九个知识簇。",
      "5. 对比关键笔记和普通永久笔记，确认两者都遵守同一模板，但关键笔记额外承担索引入口和写作主线角色。",
      "6. Inspect it in this order: `IC-SN-001` -> `IC-SN-005` -> `IC-SN-010`，看索引卡是不是围绕中心问题组织，而不是围绕目录收纳。",
      "7. 切到图谱，先看关系类型、关系理由和洞察问题，再决定这张图值不值得相信。",
      "8. 最后打开写作项目 `WP-SN-PM-001`、写作脚手架 `DS-SN-PM-001` 和最终文章 `ESSAY-SN-PM-001`，确认一条判断如何被一路带进成文结构。",
      "",
      "The point of the demo is not that Yansilu stores more material. The point is that it helps the user move from material to owned judgment, from judgment to relation, from relation to re-entry structure, and from structure to writing."
    ].join("\n")
  }));
