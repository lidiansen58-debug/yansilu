...
async function main() {
  ...
  fixture.guide_notes = asArray(fixture.guide_notes).map((guide) => ({
    ...
    body: [
      ...
      "3. 接着看多条永久笔记如何形成可写主题：打开 `IC-SN-001`、`IC-SN-005` 或 `IC-SN-010`。先读中心问题，再按顺序读里面列出的永久笔记。可写主题会保存成主题索引笔记，它不是文章，只是一个入口，帮你下次重新进入同一个问题。",
      "4. 然后从可写主题进入写作中心生成提纲：打开写作主题 `WP-SN-PM-001`，再看 `DS-SN-PM-001`。重点看可写主题和永久笔记怎样被放进写作中心，形成提纲和草稿骨架。",
