...
const ONBOARDING_GUIDE_NOTES = [
  {
    ...
    body: [
      ...
      "## 先走 5 步",
      "",
      "1. 看材料：打开 [[SRC-SMART-NOTES|How to Take Smart Notes / 卡片笔记写作法]]，知道这套样例只保存主题边界，不复刻原文。",
      "2. 看判断：打开 [[LN-SN-001|笔记流程把写作视为持续实践]] 和 [[PN-SN-001|写作不是最后一步，而是笔记系统的组织原则]]，看材料怎样先被转述，再变成一句自己愿意承担的永久笔记。",
      "3. 去建联：打开 [[PN-SN-101|关系练习：这条笔记还没有进入网络]]，给它找一条相关旧笔记，并补一句“为什么相关”。",
      "4. 看可写主题：打开 主题索引“新用户如何照着样例开始”（点导览里的“打开主题索引示例”），看 3 到 7 条永久笔记如何组成一个可以继续写的问题入口。",
      "5. 进写作中心：打开 写作中心项目“为什么研思录不是普通笔记软件”（点导览里的“打开写作中心”） 和 文章提纲（在写作中心查看），看提纲如何从已确认判断开始。",
      "",
      "## 今天只做一个动作",
      "",
      "如果你不知道先点哪里，就先做第 3 步：把 [[PN-SN-101|关系练习：这条笔记还没有进入网络]] 接入关系网。研思录不是要求你一次整理完整库，而是每次推进一个小动作。",
      "",
      "## 读完这组导览后再看",
      "",
      "- [[GUIDE-SN-002|01 今天先做哪一步]]：今天先做哪一步。",
      "- [[GUIDE-SN-003|02 什么是永久笔记]]：什么是永久笔记。",
      "- [[GUIDE-SN-004|03 为什么要建立关系]]：为什么关系必须写理由。",
      "- [[GUIDE-SN-005|04 什么是可写主题]]：什么是可写主题。",
      "- [[GUIDE-SN-006|05 怎么从主题进入写作中心]]：怎么从主题进入写作中心。"
    ].join("\n")
  },
  {
    id: "GUIDE-SN-002",
    ...
    body: [
      ...
      "## 现在可以点",
      "",
      "- 想练建联：打开 [[PN-SN-101|关系练习：这条笔记还没有进入网络]]。",
      "- 想看主题：打开 主题索引“新用户如何照着样例开始”（点导览里的“打开主题索引示例”）。",
      "- 想继续写：打开 写作中心项目“为什么研思录不是普通笔记软件”（点导览里的“打开写作中心”）。",
      "",
      "## 小判断",
      "",
  ...
  },
  {
    ...
    body: [
      ...
      "## 现在可以看",
      "",
      "- [[PN-SN-033|永久笔记是一条用户愿意承担的判断]]：永久笔记是一条用户愿意承担的判断。",
      "- [[PN-SN-103|永久笔记要先承担一个判断，再追求完整]]：永久笔记要先承担一个判断，再追求完整。",
      "",
      "## 小练习",
      "",
      "打开 [[LN-SN-001|笔记流程把写作视为持续实践]]，再打开 [[PN-SN-001|写作不是最后一步，而是笔记系统的组织原则]]。只看一件事：哪一句话已经从“书里说”变成了“我判断”。"
    ].join("\n")
  },
  {
    id: "GUIDE-SN-004",
    ...
    body: [
      ...
      "## 现在可以点",
      "",
      "打开 [[PN-SN-101|关系练习：这条笔记还没有进入网络]]，给它找一条相关永久笔记。保存前必须补一句理由，不要只因为标题像就连接。",
      "",
      "## 继续看",
      "",
      "- [[PN-SN-049|关系理由比关系数量更重要]]：关系理由比关系数量更重要。",
      "- [[PN-SN-104|关系图谱要求写清为什么相关]]：关系图谱要求写清为什么相关。"
    ].join("\n")
  },
  {
    id: "GUIDE-SN-005",
    ...
    body: [
      ...
      "## 现在可以看",
      "",
      "- 主题索引“新用户如何照着样例开始”（点导览里的“打开主题索引示例”）：新用户如何照着样例开始。",
      "- [[PN-SN-105|可写主题建议只是建议，确认后才保存]]：可写主题建议只是建议，确认后才保存。",
      "- [[PN-SN-106|主题索引不是分类文件夹，而是重新进入问题的入口]]：主题索引不是分类文件夹，而是重新进入问题的入口。",
      "",
      "## 小判断",
      "",
  ...
  },
  {
    ...
    body: [
      ...
      "## 现在可以点",
      "",
      "打开 写作中心项目“为什么研思录不是普通笔记软件”（点导览里的“打开写作中心”），再看 文章提纲（在写作中心查看）。重点看每一节都能追溯到哪些永久笔记，而不是只看标题是否好听。",
      "",
      "## 继续看",
      "",
      "- [[PN-SN-102|今日整理把方法变成下一步动作]]：今日整理把方法变成下一步动作。",
      "- [[PN-SN-107|写作中心从已确认判断开始，不从空白开始]]：写作中心从已确认判断开始，不从空白开始。"
    ].join("\n")
  }
];
...
async function main() {
  ...
  fixture.guide_notes = asArray(fixture.guide_notes).map((guide) => ({
    ...
    body: [
      ...
      "## 第一次打开先走五步",
      "",
      "1. 先看一条材料如何变成永久笔记：打开 [[SRC-SMART-NOTES|How to Take Smart Notes / 卡片笔记写作法]]，再看 [[FN-SN-001|也许笔记软件过度奖励收藏]]、[[LN-SN-001|笔记流程把写作视为持续实践]] 和 [[PN-SN-001|写作不是最后一步，而是笔记系统的组织原则]]。你要看的不是格式，而是一本书里的想法怎样先被转述，再变成“我愿意承担的一句话判断”。",
      "2. 再让一条未关联笔记进入关系网：打开 [[PN-SN-101|关系练习：这条笔记还没有进入网络]]。找一条真正相关的旧笔记，选择它们的关系，写一句“为什么要这样连”，再保存。保存以后，它就不只是单独放着的一张卡片，而是能和旧判断互相解释。",
      "3. 接着看多条永久笔记如何形成可写主题：打开 主题索引“写作为什么应该组织笔记流程”（点导览里的“打开主题索引示例”）、主题索引“关系图谱怎样服务思考”（点导览里的“打开主题索引示例”） 或 主题索引“从来源到文章的可追溯路径”（点导览里的“打开主题索引示例”）。先读中心问题，再按顺序读里面列出的永久笔记。可写主题会保存成主题索引笔记，它不是文章，只是一个入口，帮你下次重新进入同一个问题。",
      "4. 然后从可写主题进入写作中心生成提纲：打开写作主题 写作中心项目“为什么研思录不是普通笔记软件”（点导览里的“打开写作中心”），再看 文章提纲（在写作中心查看）。重点看可写主题和永久笔记怎样被放进写作中心，形成提纲和草稿骨架。",
