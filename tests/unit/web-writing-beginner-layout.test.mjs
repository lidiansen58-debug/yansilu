...
test("writing center keeps beginner four-step path above folded advanced areas", () => {
  ...
  const composePanelIndex = html.indexOf("writingComposePanel");
  const tabsIndex = html.indexOf("writing-tabs");
  ...
  assert.match(html, /<section class="writing-section" id="writingThemePanel">/);
